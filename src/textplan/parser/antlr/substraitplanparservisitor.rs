 ...
 */
pub trait SubstraitPlanParserVisitor<'input>:
    ParseTreeVisitor<'input, SubstraitPlanParserContextType>
{
    /**
...
pub trait SubstraitPlanParserVisitorCompat<'input>:
    ParseTreeVisitorCompat<'input, Node = SubstraitPlanParserContextType>
{
    /**
     * Visit a parse tree produced by {@link SubstraitPlanParser#plan}.
     * @param ctx the parse tree
     ...
     * @param ctx the parse tree
     */
    fn visit_relation_filter_behavior(
        &mut self,
        ctx: &Relation_filter_behaviorContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_relationUsesSchema(
        &mut self,
        ctx: &RelationUsesSchemaContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_relationAdvancedExtension(
        &mut self,
        ctx: &RelationAdvancedExtensionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_relationSourceReference(
        &mut self,
        ctx: &RelationSourceReferenceContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_expressionScalarSubquery(
        &mut self,
     ...
     * @param ctx the parse tree
     */
    fn visit_expressionFunctionUse(
        &mut self,
     ...
     * @param ctx the parse tree
     */
    fn visit_literal_basic_type(
        &mut self,
        ctx: &Literal_basic_typeContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_literal_complex_type(
        &mut self,
        ctx: &Literal_complex_typeContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_local_files_detail(
        &mut self,
        ctx: &Local_files_detailContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    T: SubstraitPlanParserVisitorCompat<'input>,
{
    ...
    fn visit_relation_filter_behavior(&mut self, ctx: &Relation_filter_behaviorContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_relation_filter_behavior(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_relationUsesSchema(&mut self, ctx: &RelationUsesSchemaContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_relationUsesSchema(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_relationExpression(&mut self, ctx: &RelationExpressionContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_relationExpression(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_relationAdvancedExtension(&mut self, ctx: &RelationAdvancedExtensionContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_relationAdvancedExtension(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_relationSourceReference(&mut self, ctx: &RelationSourceReferenceContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_relationSourceReference(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_expressionScalarSubquery(&mut self, ctx: &ExpressionScalarSubqueryContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionScalarSubquery(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_expressionConstant(&mut self, ctx: &ExpressionConstantContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionConstant(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_expressionFunctionUse(&mut self, ctx: &ExpressionFunctionUseContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionFunctionUse(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_expressionSetComparisonSubquery(
        ...
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionSetComparisonSubquery(
                self, ctx,
            );
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_expressionInPredicateSubquery(
        ...
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionInPredicateSubquery(
                self, ctx,
            );
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_expressionSetPredicateSubquery(
        ...
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_expressionSetPredicateSubquery(
                self, ctx,
            );
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_literal_basic_type(&mut self, ctx: &Literal_basic_typeContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_literal_basic_type(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_literal_complex_type(&mut self, ctx: &Literal_complex_typeContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_literal_complex_type(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_local_files_detail(&mut self, ctx: &Local_files_detailContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_local_files_detail(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }

    fn visit_named_table_detail(&mut self, ctx: &Named_table_detailContext<'input>) {
        let result =
            <Self as SubstraitPlanParserVisitorCompat>::visit_named_table_detail(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
