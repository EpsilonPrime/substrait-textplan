...
pub trait SubstraitPlanParserListener<'input>:
    ParseTreeListener<'input, SubstraitPlanParserContextType>
{
    /**
    ...
    /**
     * Enter a parse tree produced by the {@code relationOffset}
     * labeled alternative in {@link SubstraitPlanParser#relation_detail}.
     * @param ctx the parse tree
     */
    fn enter_relationOffset(&mut self, _ctx: &RelationOffsetContext<'input>) {}
    /**
     * Exit a parse tree produced by the {@code relationOffset}
     * labeled alternative in {@link SubstraitPlanParser#relation_detail}.
     * @param ctx the parse tree
     */
    fn exit_relationOffset(&mut self, _ctx: &RelationOffsetContext<'input>) {}
    /**
     ...
     * @param ctx the parse tree
     */
    fn enter_expressionSetComparisonSubquery(
        &mut self,
        _ctx: &ExpressionSetComparisonSubqueryContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_expressionSetComparisonSubquery(
        &mut self,
        _ctx: &ExpressionSetComparisonSubqueryContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_expressionInPredicateSubquery(
        &mut self,
     ...
     * @param ctx the parse tree
     */
    fn exit_expressionInPredicateSubquery(
        &mut self,
        _ctx: &ExpressionInPredicateSubqueryContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_expressionSetPredicateSubquery(
        &mut self,
     ...
     * @param ctx the parse tree
     */
    fn exit_expressionSetPredicateSubquery(
        &mut self,
        _ctx: &ExpressionSetPredicateSubqueryContext<'input>,
    ) {
    }
