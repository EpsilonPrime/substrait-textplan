...
pub type RelationOffsetContext<'input> =
    BaseParserRuleContext<'input, RelationOffsetContextExt<'input>>;
...
pub trait RelationOffsetContextAttrs<'input>: SubstraitPlanParserContext<'input> {
    ...
    fn OFFSET(&self) -> Option<Rc<TerminalNode<'input, SubstraitPlanParserContextType>>>
    where
        Self: Sized,
    {
...
impl<'input, 'a> Listenable<dyn SubstraitPlanParserListener<'input> + 'a>
    for RelationOffsetContext<'input>
{
    fn enter(&self, listener: &mut (dyn SubstraitPlanParserListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> RelationOffsetContextExt<'input> {
    fn new(ctx: &dyn Relation_detailContextAttrs<'input>) -> Rc<Relation_detailContextAll<'input>> {
        Rc::new(Relation_detailContextAll::RelationOffsetContext(
            BaseParserRuleContext::copy_from(
                ctx,
                RelationOffsetContextExt {
                    base: ctx.borrow().clone(),
                    ph: PhantomData,
                },
            ),
            ...
            recog.base.enter_outer_alt(None, 1);
            {
                ...
                while (((_la - 39) & !0x3f) == 0
                    && ((1usize << (_la - 39))
                        & ((1usize << (URI_FILE - 39))
                            | (1usize << (URI_PATH - 39))
                            | (1usize << (URI_PATH_GLOB - 39))
                            | (1usize << (URI_FOLDER - 39))
                            | (1usize << (PARTITION_INDEX - 39))
                            | (1usize << (START - 39))
                            | (1usize << (LENGTH - 39))
                            | (1usize << (ORC - 39))
                            | (1usize << (PARQUET - 39))))
